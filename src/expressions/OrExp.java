...
import resources.*;
/**
 * OrExp.java - Used for representing the boolean 'or' operator.
 * 
 * @author Justin
 */
public class OrExp extends Operator {
	/**
	 * Creates a new OrExp instance.
	 * 
	 * @param op the operator associated with this operator
	 * @param priority the priority of this operator
	 */
	public OrExp(String op, int priority) {
