...
import resources.*;
/**
 * JUnitTesting.java - Used for running our JUnit test cases.
 * 
 * @author Bryan
 */
public class JUnitTesting {
	...
	public void divZeroTest() {
		// Testing division by zero...it returns Double.NaN
		try {
		IntegerEval test7 = new IntegerEval();
		System.out.println("Testing Evaluation for: 7/0");
		assertTrue(test7.evaluate("7/0") == 2147483647); // Double.NaN
		} catch(NoSuchVariableExistsException e) {
		} catch(InvalidExpressionException e) {
		} catch(VariableAssignmentException e) {
		}
